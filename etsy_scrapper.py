...
def export_data():
    if 'scrappedReviews_1.csv' in os.listdir(os.getcwd()):
        df1 = pd.read_csv('scrappedReviews_1.csv')
        '''Exporting data'''
        ...
        result.to_csv('scrappedReviews_1.csv',index=False)
    else:
        '''Exporting data'''
        dataframe1 = pd.DataFrame()
        dataframe1["Person"] = person
        ...
        dataframe1["Reviews"] = review
        dataframe1["Sentiment"] = sentiment
        dataframe1.to_csv('scrappedReviews_1.csv',index=False)
